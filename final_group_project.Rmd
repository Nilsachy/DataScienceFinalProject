...
card_fraud %>%
    ...
    ggplot(aes(x = day_of_year, y = num_of_fraud, color=trans_year)) +
      geom_smooth() +
...
```{r}
### MANIPULATED DATA FOR SIMPLICITY, INSERT FINAL MODIFIED / ENGINEERED DF
card_fraud <- card_fraud %>% 
  select(year, category, amt, is_fraud, hour, wday, month_name, age)
```
